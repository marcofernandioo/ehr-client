...
export default function OrderTable({ pendingTransactions }) {
              ...
              pendingTransactions.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{row.signature.slice(0, 10) + '....'}</TableCell>
                    <TableCell align="left">{row.hash.slice(0, 10) + '....'} </TableCell>
                  </TableRow>
                );
              })}
          </TableBody>
